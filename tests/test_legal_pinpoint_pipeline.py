...
from scripts.legal_pinpoint_fetcher import LegalDocumentFetcher, PinpointVerifier, Paragraph
...
def test_pinpoint_offline_fixture():
    ...
    def fake_searcher(_q): return ["file://tests/fixtures/rootes.html"]
    def fake_fetcher(_u): return paragraphs
